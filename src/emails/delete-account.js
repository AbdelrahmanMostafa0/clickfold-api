                ...
                <tr>
                  <td>
                    ...
                    <p style="color:#a0a0a0;font-size:15px;line-height:1.6;margin:0 0 12px;">
                      We received a request to delete your <strong>b8lnk</strong> account.
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="center" style="padding:28px 0;">
                    <a href="https://b8lnk.vercel.app/delete-account/${token}"
                ...
                <tr>
                  <td align="center">
                    <p style="color:#555;font-size:12px;text-align:center;margin:0;">
                      &copy; 2026 b8lnk &middot; You received this because a deletion was requested for your account.
                    </p>
                  </td>
                </tr>
              </table>
