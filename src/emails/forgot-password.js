                ...
                <tr>
                  <td>
                    ...
                    <p style="color:#a0a0a0;font-size:15px;line-height:1.6;margin:0 0 12px;">
                      We received a request to reset the password for your <strong>Clickfold</strong> account.
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="center" style="padding:28px 0;">
                    <a href="https://clickfold.vercel.app/reset-password/${token}"
                ...
                <tr>
                  <td align="center">
                    <p style="color:#666;font-size:13px;line-height:1.5;text-align:center;margin:0 0 8px;">
                      ...
                      <a href="https://clickfold.vercel.app/reset-password/${token}" style="color:#6366f1;word-break:break-all;">
                        https://clickfold.vercel.app/reset-password/${token}
                      </a>
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td align="center">
                    <p style="color:#555;font-size:12px;text-align:center;margin:0;">
                      &copy; 2026 Clickfold &middot; You received this because a password reset was requested for your account.
                    </p>
                  </td>
                </tr>
              </table>
